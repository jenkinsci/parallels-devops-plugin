 ...
 *
 * <ul>
 *   <li>{@link CloneProvisioningConfig} — clone an existing VM by name or ID.
 *       Available in both HOST and ORCHESTRATOR modes.
 *       In ORCHESTRATOR mode, use the VM ID instead of the VM name.</li>
